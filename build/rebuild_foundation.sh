...
pushd $SELF_DIR/../vagrant
    ...
    vagrant scp :~/swift-source/build/Ninja-ReleaseAssert+stdlib-Release/foundation-linux-x86_64/Foundation/libFoundation.so $SWIFT_ANDROID_HOME/toolchain/usr/lib/swift/android/
